	...
	public:
		QuizAppForm(void)
		{
			...
			questions->Add(gcnew Question(
				"Какой тип архитектуры используется в современных версиях Windows?",
			...
			questions->Add(gcnew Question(
				"Как называется основной интерфейс для взаимодействия с функциями Windows?",
